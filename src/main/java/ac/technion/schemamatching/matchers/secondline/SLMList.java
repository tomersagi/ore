...
public enum SLMList {OBMWBG(new OBmwbg()),OBSM(new OBStableMarriage()),
	...
	OBThreshold050(new OBThreshold(0.50)),
	OBThreshold075(new OBThreshold(0.75)),
	OBThreshold085(new OBThreshold(0.85)),
	OBThreshold090(new OBThreshold(0.90)),
	OBThreshold095(new OBThreshold(0.95)),
	...
	OBFuncDep(new OBFuncDepend()), Behavioral2LM(new BehavioralMatcher());
