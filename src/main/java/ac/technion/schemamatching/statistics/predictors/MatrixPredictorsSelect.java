 ...
 *
 */
public class MatrixPredictorsSelect implements Statistic {
    ...
    public MatrixPredictorsSelect(String predName)
    {
        HashMap<String,Predictor> allpredictors = new HashMap<String,Predictor>();
        allpredictors.put("BMPredictor", new BMPredictor());
        allpredictors.put("BMMPredictor", new BMMPredictor());
        allpredictors.put("LMMPredictor", new LMMPredictor());
        allpredictors.put("STDEVPredictor", new STDEVPredictor());
        allpredictors.put("MaxPredictor", new MaxPredictor());
        allpredictors.put("AvgConfPredictor", new AvgPredictor());
